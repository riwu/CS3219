  ...
  <div>
    ...
    {props.topStats.title &&
      <h3 className="app-filterTitle">
        Top <span className="app-filterTitleSpecial">{props.topStats.title.count} {props.topStats.title.aggregator}</span> by
        {' '}<span className="app-filterTitleSpecial">{props.topStats.title.metric}</span>
      </h3>
    }
